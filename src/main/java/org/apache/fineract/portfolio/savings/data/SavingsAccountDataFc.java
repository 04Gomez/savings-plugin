 ...
 */
@Getter
public final class SavingsAccountDataFc implements Serializable {
    ...
    private final Collection<SavingsAccountTransactionDataFc> transactions;
    ...
    private transient List<SavingsAccountTransactionDataFc> savingsAccountTransactionData = new ArrayList<>();

    private transient SavingsAccountTransactionDataFc lastSavingsAccountTransaction;
    ...
    private transient List<SavingsAccountTransactionDataFc> newSavingsAccountTransactionData = new ArrayList<>();
    ...
    public static SavingsAccountDataFc importInstanceIndividual(Long clientId, Long productId, Long fieldOfficerId, LocalDate submittedOnDate,
            ...
            String dateFormat) {
        return new SavingsAccountDataFc(clientId, productId, fieldOfficerId, submittedOnDate, nominalAnnualInterestRate,
    ...
    private SavingsAccountDataFc(Long clientId, Long productId, Long fieldOfficerId, LocalDate submittedOnDate,
    ...
    public static final Comparator<SavingsAccountDataFc> ClientNameComparator = (savings1, savings2) -> {
    ...
    public void setNewSavingsAccountTransactionData(final SavingsAccountTransactionDataFc savingsAccountTransactionData) {
    ...
    public void setSavingsAccountTransactionData(final SavingsAccountTransactionDataFc savingsAccountTransactionData) {
    ...
    public void setUpdatedTransactions(List<SavingsAccountTransactionDataFc> savingsAccountTransactionDataList) {
    ...
    public void updateTransactions(final SavingsAccountTransactionDataFc savingsAccountTransactionData) {
        this.savingsAccountTransactionData.add(savingsAccountTransactionData);
    }
    ...
    public SavingsAccountTransactionDataFc findLastTransaction(final LocalDate date) {

        SavingsAccountTransactionDataFc savingsTransaction = null;
        List<SavingsAccountTransactionDataFc> trans = getSavingsAccountTransactionData();
        for (final SavingsAccountTransactionDataFc transaction : trans) {
    ...
    public Collection<Long> findCurrentTransactionIdsWithPivotDateConfig() {
        ...
        List<SavingsAccountTransactionDataFc> trans = this.savingsAccountTransactionData;
        for (final SavingsAccountTransactionDataFc transaction : trans) {
    ...
    public List<SavingsAccountTransactionDataFc> getSavingsAccountTransactionsWithPivotConfig() {
    ...
    public static SavingsAccountDataFc importInstanceGroup(Long groupId, Long productId, Long fieldOfficerId, LocalDate submittedOnDate,
            BigDecimal nominalAnnualInterestRate, EnumOptionData interestCompoundingPeriodTypeEnum,
            EnumOptionData interestPostingPeriodTypeEnum, EnumOptionData interestCalculationTypeEnum,
            EnumOptionData interestCalculationDaysInYearTypeEnum, BigDecimal minRequiredOpeningBalance, Integer lockinPeriodFrequency,
            EnumOptionData lockinPeriodFrequencyTypeEnum, boolean applyWithdrawalFeeForTransfers, Integer rowIndex, String externalId,
        ...
        return new SavingsAccountDataFc(groupId, productId, fieldOfficerId, submittedOnDate, nominalAnnualInterestRate,
                interestCompoundingPeriodTypeEnum, interestPostingPeriodTypeEnum, interestCalculationTypeEnum,
                interestCalculationDaysInYearTypeEnum, minRequiredOpeningBalance, lockinPeriodFrequency, lockinPeriodFrequencyTypeEnum,
    ...
    private SavingsAccountDataFc(Long groupId, Long productId, Long fieldOfficerId, LocalDate submittedOnDate,
            BigDecimal nominalAnnualInterestRate, EnumOptionData interestCompoundingPeriodType, EnumOptionData interestPostingPeriodType,
            EnumOptionData interestCalculationType, EnumOptionData interestCalculationDaysInYearType, BigDecimal minRequiredOpeningBalance,
            Integer lockinPeriodFrequency, EnumOptionData lockinPeriodFrequencyType, boolean withdrawalFeeForTransfers, Integer rowIndex,
    ...
    public static SavingsAccountDataFc instance(final Long id, final String accountNo, final EnumOptionData depositType,
        ...
        final Collection<SavingsAccountTransactionDataFc> transactions = null;
        final Collection<SavingsAccountChargeData> charges = null;
        final Collection<ChargeData> chargeOptions = null;

        return new SavingsAccountDataFc(id, accountNo, depositType, externalId, groupId, groupName, clientId, clientName, productId,
    ...
    public static SavingsAccountDataFc lookup(final Long accountId, final String accountNo, final EnumOptionData depositType) {
        ...
        return new SavingsAccountDataFc(accountId, accountNo, depositType, externalId, groupId, groupName, clientId, clientName, productId,
    ...
    public static SavingsAccountDataFc lookupWithProductDetails(final Long accountId, final String accountNo,
    ...
    public static SavingsAccountDataFc withTemplateOptions(final SavingsAccountDataFc account, final SavingsAccountDataFc template,
            final Collection<SavingsAccountTransactionDataFc> transactions, final Collection<SavingsAccountChargeData> charges) {
        ...
        return new SavingsAccountDataFc(account.id, account.accountNo, account.depositType, account.externalId, account.groupId,
    ...
    public static SavingsAccountDataFc withTemplateOptionsFc(final SavingsAccountDataFc account, final SavingsAccountDataFc template,
            final Collection<SavingsAccountTransactionDataFc> transactions, final Collection<SavingsAccountChargeData> charges) {
        ...
        if (template == null) {
            ...
            return withTemplateOptionsFc(account, productOptions, fieldOfficerOptions, interestCompoundingPeriodTypeOptions,
                    interestPostingPeriodTypeOptions, interestCalculationTypeOptions, interestCalculationDaysInYearTypeOptions,
                    lockinPeriodFrequencyTypeOptions, withdrawalFeeTypeOptions, transactions, charges, chargeOptions);
        }
    ...
    public static SavingsAccountDataFc withTemplateOptions(final SavingsAccountDataFc account,
    ...
    public static SavingsAccountDataFc withTemplateOptionsFc(final SavingsAccountDataFc account,
            final Collection<SavingsProductData> productOptions, final Collection<StaffData> fieldOfficerOptions,
            final Collection<EnumOptionData> interestCompoundingPeriodTypeOptions,
            final Collection<EnumOptionData> interestPostingPeriodTypeOptions,
            final Collection<EnumOptionData> interestCalculationTypeOptions,
    ...
    public static SavingsAccountDataFc withClientTemplate(final Long clientId, final String clientName, final Long groupId,
    ...
    private SavingsAccountDataFc(final Long id, final String accountNo, final EnumOptionData depositType, final String externalId,
            ...
            final Collection<SavingsAccountTransactionDataFc> transactions, final Collection<SavingsProductData> productOptions,
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof SavingsAccountDataFc)) {
            return false;
        }
        final SavingsAccountDataFc rhs = (SavingsAccountDataFc) obj;
    ...
    public void setLastSavingsAccountTransaction(SavingsAccountTransactionDataFc lastSavingsAccountTransaction) {
