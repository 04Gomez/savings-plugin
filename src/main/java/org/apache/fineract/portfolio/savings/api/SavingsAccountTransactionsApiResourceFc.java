...
@Slf4j
public class SavingsAccountTransactionsApiResourceFc {

    private final PlatformSecurityContext context;
    private final DefaultToApiJsonSerializer<SavingsAccountTransactionDataFc> toApiJsonSerializer;
    private final PortfolioCommandSourceWritePlatformService commandsSourceWritePlatformService;
    private final ApiRequestParameterHelper apiRequestParameterHelper;
    private final SavingsAccountReadPlatformServiceImplFc savingsAccountReadPlatformService;
    ...
    public String retrieveTemplate(@PathParam("savingsAccountId") final Long savingsAccountId,
        ...
        SavingsAccountTransactionDataFc savingsAccount = this.savingsAccountReadPlatformService.retrieveDepositTransactionTemplateFc(savingsAccountId,
                DepositAccountType.SAVINGS_DEPOSIT);
        final Collection<PaymentTypeData> paymentTypeOptions = this.paymentTypeReadPlatformService.retrieveAllPaymentTypes();
        savingsAccount = SavingsAccountTransactionDataFc.templateOnTop(savingsAccount, paymentTypeOptions);
    ...
    public String retrieveOne(@PathParam("savingsAccountId") final Long savingsAccountId, @PathParam("transactionId") final Long transactionId,
        ...
        if (settings.isTemplate()) {
            final Collection<PaymentTypeData> paymentTypeOptions = this.paymentTypeReadPlatformService.retrieveAllPaymentTypes();
            transactionData = SavingsAccountTransactionDataFc.templateOnTop(transactionData, paymentTypeOptions);
        }
